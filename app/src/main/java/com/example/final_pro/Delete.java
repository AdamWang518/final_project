    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String url = "http://192.168.50.36/Loginregister/locationdelete.php";
                ...
                sendRequest(url, object, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        sendPlaceRequest();
                        Toast.makeText(Delete.this, "刪除成功", Toast.LENGTH_SHORT).show();
                    }
...
//                }
    ...
    private void sendPlaceRequest() {
        ...
        if (type.equals("F")) {
            url = "http://192.168.50.36/Loginregister/fireadd.php";
            JSONObject object = new JSONObject();
            try {
                object.put("name", name);
                object.put("city", city);
        ...
        if (type.equals("P")) {
            url = "http://192.168.50.36/Loginregister/policeadd.php";
            JSONObject object = new JSONObject();
            try {
                object.put("name", name);
                object.put("city", city);
